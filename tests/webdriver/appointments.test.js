...
test('This test will access the patients request page and attempt to cancel an appointment with a reason exceeding 255 characters', async () => {
    ...
    await driver.findElement(By.css('textarea[id="ap-5e777c661e2a32.34520912-reason"]')).sendKeys('Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. Everything is fine. ');
