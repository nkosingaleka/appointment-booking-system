...
class UserManager {
  ...
  public static function receiveEmail() {
    ...
    $mail->Username = 'jakelove15s@gmail.com';                 // SMTP username
    $mail->Password = '78RanGers01FuckOfF678';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 465;                                    // TCP port to connect to

    $mail->setFrom('jakelove15s@gmail.com', 'Jake');

    $mail->addAddress('up734426@myport.ac.uk', 'Patient');     // Add a recipient
